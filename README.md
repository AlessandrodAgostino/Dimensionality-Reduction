...
regression algorithm is shown below in Figure 1, after a
...
![](one_set_coefs.png)
Figure 1: _The three plots above show the three coefficients sets obtained
...
From the silhouette of the curves in Figure 1 it’s clear
...
1). The precise detection of the *elbow* point it’s not a
...
follows below (a more detailed list in Appendix 1)
...
1 $^{st}$ Application - *Brain Challenge*
========================================
...
2 is shown the distribution among gender and age in
the 16 different sites of analysis.

![](violin_gender_site.png)
Figure 2: _Series of violin graphs that show the distribution in gender and age
...
Has previously stated, as can be seen in Figure 1, the
...
![](three_graphs.png)
Figure 3:_These are the three R $^2$ score obtained training the SVR on three
...
In the plots in Figure|3 those R $^2$ score are
...
2 $^{nd}$ Application - *Cardiological Data*
===========================================
...
Figure 4: _In this dataseta the distribution among ages between gender is quite
...
and the R $^2$ score computed (Figure 5).

![](four_graphs.png)
Figure 5: These are the three R $^2$ score obtained training the GPR on four
...
In the plots shown in Figure 5 it’s possible to see
